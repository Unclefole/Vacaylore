...
{{--                <li class="breadcrumb-item"><a href="{{route('admin_jobs')}}">Favored Scenery-List</a></li>--}}
                <li class="breadcrumb-item active" aria-current="page">Favored Scenery-Add</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Favored Scenery Add</h1>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-lg-12 col-sm-12">
                                ...
                                @endif
                                <form action="{{route('admin_add_edit_favored_scenery')}}" method="POST" enctype="multipart/form-data">@csrf
                                    <div class="mb-4">
